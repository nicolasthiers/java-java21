...
public class Stream_03_Test {
	...
	public void test_max() throws Exception {
		...
		Optional<Order> result = orders.stream().max(Comparator.comparingDouble(o -> o.getPrice()));
	...
	public void test_min() throws Exception {
		...
		Optional<Order> result = orders.stream().min(Comparator.comparingDouble(o -> o.getPrice()));
