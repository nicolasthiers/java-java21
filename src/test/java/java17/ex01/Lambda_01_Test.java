...
public class Lambda_01_Test {
    ...
    public void test_filter_by_age() throws Exception {
        ...
        List<Person> result = filter(personList, pp);
    ...
    public void test_filter_by_firstname() throws Exception {
        ...
        PersonPredicate pp = p -> p.getFirstname().equals("first_10");
        List<Person> result = filter(personList, pp);
    ...
    public void test_filter_by_password() throws Exception {
        ...
        PersonPredicate pp = p -> p.getAge() > 49 && DigestUtils.sha512Hex(p.getPassword()).equals(passwordSha512Hex);
